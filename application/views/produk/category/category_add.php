                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= site_url('category/process') ?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control shadow-sm" name="nama_category" value="<?= $row->nama_category?>" required>
                            ...
                            <a href="<?= site_url('category') ?>" class="btn btn-warning"><i class="fas fa-undo"></i> Kembali</a>
                            </div>
                        </form>
                    </div>
                </div>
