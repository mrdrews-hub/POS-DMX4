<div class="main-content">
    <section class="section">
        ...
        <div class="card-header">
                <h2 class="section-title"><?php echo $ket; ?></h2>
        </div>
          <div class="card-body">
    ...
    <a class="btn btn-primary btn-sm float-right" href="<?php echo $url_cetak; ?>" target="_blank"><i class="fas fa-file-pdf"></i> CETAK PDF</a>
                            ...
                            <?php
                              if( ! empty($transaksi)){
                                ...
                                foreach($transaksi as $data){
                                  ...
                                  echo "<td class='text-center'>".$data->nama_item."</td>";
                                  echo "<td class='text-center'>".$data->qty."</td>";
                                  echo "<td class='text-center'>".$data->nama_supplier."</td>";
                                  echo "</tr>";
                                  $no++;
                                }
                              }
