<div class="main-content">
    <section class="section">
        ...
        <div class="card-header">
          ...
          <div class="card-body">
          <a href="<?= site_url('stock/in/add') ?>" class="btn btn-success mb-1 mr-2 float-right"> <i class="fas fa-plus"></i> Add Stock</a>
                            ...
                            <?php $i=1;
                                ...
                                <tr>
                                    ...
                                    <td class="text-center w-25">
                                        ...
                                        <a href="<?=site_url('stock/in/delete/'.$data->stock_id.'/'.$data->item_id) ?>" class="btn btn-danger">
