...
<section class="section">
        ...
        <div class="card-header">
                <h2 class="section-title">Form Retur</h2>
        </div>
                    <div class="card-body">
                        ...
                        <form action="<?= site_url('stock/process') ?>" method="post">
                            ...
                            <button type="submit" class="btn btn-success mr-3" name="out_add">
                            <i class="fas fa-location-arrow"></i> Tambah
                            </button>
                            <a href="<?= site_url('stock/out') ?>" class="btn btn-warning"><i class="fas fa-undo"></i> Kembali</a>
                            </div>
                        </form>
                    </div>
                </div>
